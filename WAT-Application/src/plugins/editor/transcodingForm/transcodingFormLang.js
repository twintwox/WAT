...
WAT.module('$transcodingFormLang',['$lang'],function($lang){
    ...
    $lang.extend('ES',{
        ...
        content_type_region 	: 'Región general: Agrupación general de importancia que será agregada en la tabla de contenidos',
        content_type_main		: 'Región principal: Idem Región general, pero a su vez define el contenido principal',
        content_type_search		: 'Región de búsqueda: Idem Región general, pero a su vez define un buscador del sitio',
        content_type_group 		: 'Sección: Agrupación general que no será agregado en la tabla de contenidos',
        content_type_article	: 'Sección asociable: Idem Sección, pero a su vez asocia el contenido a sus ancestros que posean este mismo rol',
    ...
    $lang.extend('EN',{
        ...
        content_type_group 		: 'Section: General group. Won\'t be added to the table of contents.',
        content_type_article	: 'Associative section: Same as Section, but associates its contents with internal and parents groups the share this type of role.',
